    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ url('/chefMenu', $chef->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category" class="form-control text-white">
                            ...
                            @foreach ($category as $categories)
                                <option {{ $categories->id == $chef->category_id ? 'selected' : '' }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" id="alamat" class="form-control text-white" rows="10">{{ $chef->alamat }}</textarea>
                    </div>
